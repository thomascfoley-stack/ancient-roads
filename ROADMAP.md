...
> - **Still to clear before publish:** wire the needs-review PD sources (Catena/Gregory/Cyril), scope the tail-expansion, + libsword CrossWire-5. Then the final published/quarantined/dropped tally before publish.
