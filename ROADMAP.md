...
> - **Still to clear before publish:** scale the patristic classify (repair-or-quarantine) + the libsword CrossWire-5. Then the final corpus-shape tally (published/quarantined/dropped) before publish.
