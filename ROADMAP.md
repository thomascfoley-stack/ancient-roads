...
> - **Still to clear before publish (recommended, on the accuracy evidence):** wire Catena Aurea + CrossWire-5, re-measure accuracy (target ~100%); then final published/quarantined/dropped tally. Skip the 70% patristic tail (low value per §12–13).
