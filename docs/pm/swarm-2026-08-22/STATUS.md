...
| W-RELVOICE | 1b | IN-FLIGHT — lane position 6 (apply 127 on dev + caller re-exercise; prod apply = packet B1) | `swarm/W-RELVOICE-related-voices-source-type` @ 71ef715 |
...
| W-SIXWORKS | 6 | IN-FLIGHT — enumeration only (no ingest) | `swarm/w-sixworks-enumeration` (launching) |
