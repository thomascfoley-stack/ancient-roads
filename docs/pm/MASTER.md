...
| A3 | Census adjudicated — a published-but-not-admitted work is a STOP | Blocked on A2. STOP rules are already code and red-proved (`lib/publish-flip-census.mjs`) but nothing runs them on A2's output — one small offline adjudicator closes it |
