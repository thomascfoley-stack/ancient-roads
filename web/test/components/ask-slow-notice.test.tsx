...
//
// `Progress` (ask-progress.tsx — split out of ask-client.tsx on 2026-09-06, which also
// re-exports SLOW_ANSWER_NOTICE_MS) renders a staged progress indicator and, after
