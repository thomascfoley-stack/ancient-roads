...
describe('draft-check route — limiter → apiError mapping', () => {
  ...
  // Commit 6daff0e7 (2026-09-16) added the fleet-wide `corpus:global:day` ceiling shared across
  // the corpus-search limiters (this route's shared `corpus-search:*` bucket included), making
