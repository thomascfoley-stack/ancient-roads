          ...
          return (
            ...
            >
              ...
              <sup
                ...
                className="relative mr-0.5 cursor-pointer font-sans text-micro font-semibold text-accent-600/80 select-none before:absolute before:-inset-y-2 before:-left-3 before:-right-1 before:content-[''] hover:text-accent-700 dark:text-accent-300/80 dark:hover:text-accent-200"
              >
                {v.verse}
              </sup>
              {foreignColor && (
