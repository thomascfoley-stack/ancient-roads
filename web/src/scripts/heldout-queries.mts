...
export const FROZEN: Q[] = [
  ...
  // ── Epistle-topic (25) — catechism proof-texts ──
  { id: 'f-ep-01', cat: 'epistle', query: 'effectual calling by the Word and Spirit', expected: ['2 Timothy 1', '2 Thessalonians 2', '2 Corinthians 3'], source: 'WSC Q31' },
  { id: 'f-ep-02', cat: 'epistle', query: 'regeneration, born again by the Spirit', expected: ['Titus 3', 'John 3', 'Ephesians 2'], source: 'HC LD 3' },
  { id: 'f-ep-03', cat: 'epistle', query: 'union with Christ, in him and he in us', expected: ['Romans 6', 'Galatians 2', 'Ephesians 1'], source: 'WSC Q30' },
  { id: 'f-ep-04', cat: 'epistle', query: 'redemption through the blood of Christ', expected: ['Ephesians 1', 'Colossians 1', '1 Peter 1'], source: 'HC LD 5-6' },
  { id: 'f-ep-05', cat: 'epistle', query: 'reconciliation with God through Christ', expected: ['2 Corinthians 5', 'Romans 5', 'Colossians 1'], source: 'HC LD 6' },
  { id: 'f-ep-06', cat: 'epistle', query: 'the imputation of the righteousness of Christ', expected: ['2 Corinthians 5', 'Romans 4', 'Romans 5'], source: 'WSC Q33' },
  { id: 'f-ep-07', cat: 'epistle', query: 'election and predestination unto salvation', expected: ['Ephesians 1', 'Romans 8', 'Romans 9'], source: 'HC LD 21' },
  { id: 'f-ep-08', cat: 'epistle', query: 'the perseverance of the saints, kept by God', expected: ['John 10', 'Romans 8', 'Philippians 1'], source: 'HC LD 1' },
  { id: 'f-ep-09', cat: 'epistle', query: 'assurance of salvation and the witness of the Spirit', expected: ['Romans 8', '1 John 5', 'Hebrews 6'], source: 'WSC Q36' },
  { id: 'f-ep-10', cat: 'epistle', query: 'walking by the Spirit and not the flesh', expected: ['Galatians 5', 'Romans 8'], source: 'HC LD 33' },
  { id: 'f-ep-11', cat: 'epistle', query: 'faith versus works and the example of Abraham', expected: ['James 2', 'Romans 4', 'Galatians 3'], source: 'WSC Q86' },
  { id: 'f-ep-12', cat: 'epistle', query: 'the law as a schoolmaster leading us to Christ', expected: ['Galatians 3', 'Romans 7'], source: 'WSC Q39-40' },
  { id: 'f-ep-13', cat: 'epistle', query: 'dying and rising with Christ in baptism', expected: ['Romans 6', 'Colossians 2'], source: 'HC LD 26-27' },
  { id: 'f-ep-14', cat: 'epistle', query: 'Christ our high priest forever', expected: ['Hebrews 4', 'Hebrews 7', 'Hebrews 9'], source: 'WSC Q25' },
  { id: 'f-ep-15', cat: 'epistle', query: 'Christ the one mediator between God and men', expected: ['1 Timothy 2', 'Hebrews 8', 'Hebrews 9'], source: 'HC LD 6' },
  { id: 'f-ep-16', cat: 'epistle', query: 'the second coming and the day of the Lord', expected: ['1 Thessalonians 4', '2 Peter 3', '2 Thessalonians 1'], source: 'HC LD 19' },
  { id: 'f-ep-17', cat: 'epistle', query: 'the resurrection of the body at the last day', expected: ['1 Corinthians 15', '1 Thessalonians 4', 'Philippians 3'], source: 'HC LD 22' },
  { id: 'f-ep-18', cat: 'epistle', query: 'salvation by grace and not by law', expected: ['Ephesians 2', 'Romans 11', 'Titus 2'], source: 'WSC Q33' },
  { id: 'f-ep-19', cat: 'epistle', query: 'the indwelling of the Holy Spirit in believers', expected: ['Romans 8', '1 Corinthians 6', 'Ephesians 1'], source: 'HC LD 20' },
  { id: 'f-ep-20', cat: 'epistle', query: 'spiritual gifts and the one body of Christ', expected: ['1 Corinthians 12', 'Romans 12', 'Ephesians 4'], source: 'HC LD 21' },
  { id: 'f-ep-21', cat: 'epistle', query: 'the peace of God that surpasses understanding', expected: ['Philippians 4', 'Colossians 3'], source: 'HC LD 1' },
  { id: 'f-ep-22', cat: 'epistle', query: 'putting off the old self and putting on the new', expected: ['Ephesians 4', 'Colossians 3'], source: 'WSC Q35' },
  { id: 'f-ep-23', cat: 'epistle', query: "God's love in Christ dying for sinners", expected: ['Romans 5', '1 John 4'], source: 'HC LD 6' },
  { id: 'f-ep-24', cat: 'epistle', query: 'the wages of sin and the free gift of God', expected: ['Romans 6', 'Romans 5'], source: 'WSC Q84' },
  { id: 'f-ep-25', cat: 'epistle', query: 'glorification, conformed to the image of Christ', expected: ['Romans 8', '1 John 3', 'Philippians 3'], source: 'WSC Q38' },

  // ── General topical (20) — catechism / cross-canon, proof-texts ──
  { id: 'f-tp-01', cat: 'topical', query: 'the sovereignty of God over the nations', expected: ['Psalm 47', 'Daniel 4', 'Isaiah 46'], source: 'WSC Q7-8' },
  { id: 'f-tp-02', cat: 'topical', query: 'the fear of the LORD is the beginning of wisdom', expected: ['Proverbs 1', 'Proverbs 9', 'Psalm 111'] },
  { id: 'f-tp-03', cat: 'topical', query: 'repentance and turning from sin to God', expected: ['Ezekiel 18', 'Acts 3', '2 Corinthians 7'], source: 'WSC Q87' },
  { id: 'f-tp-04', cat: 'topical', query: 'how we ought to pray to God', expected: ['Matthew 6', 'Luke 11', 'Philippians 4'], source: 'WSC Q98' },
  { id: 'f-tp-05', cat: 'topical', query: 'the forgiveness of sins', expected: ['Psalm 32', '1 John 1', 'Colossians 2'], source: 'HC LD 21' },
  { id: 'f-tp-06', cat: 'topical', query: 'humanity made in the image of God', expected: ['Genesis 9', 'James 3', 'Colossians 3'], source: 'WSC Q10' },
  { id: 'f-tp-07', cat: 'topical', query: 'the covenant God made with Abraham', expected: ['Genesis 12', 'Genesis 15', 'Genesis 17'] },
  { id: 'f-tp-08', cat: 'topical', query: 'the faithfulness and steadfast love of God', expected: ['Lamentations 3', 'Psalm 136', 'Deuteronomy 7'] },
  { id: 'f-tp-09', cat: 'topical', query: 'the kingdom of God is at hand', expected: ['Mark 1', 'Matthew 13', 'Luke 17'] },
  { id: 'f-tp-10', cat: 'topical', query: 'idolatry and the worship of false gods', expected: ['Isaiah 44', 'Exodus 20', '1 Corinthians 10'], source: 'WSC Q47-49' },
  { id: 'f-tp-11', cat: 'topical', query: 'humility and the danger of pride', expected: ['Proverbs 16', 'James 4', '1 Peter 5'] },
  { id: 'f-tp-12', cat: 'topical', query: 'the tongue and the power of words', expected: ['James 3', 'Proverbs 18', 'Ephesians 4'] },
  { id: 'f-tp-13', cat: 'topical', query: 'money, wealth, and the love of it', expected: ['1 Timothy 6', 'Matthew 6', 'Proverbs 30'] },
  { id: 'f-tp-14', cat: 'topical', query: 'marriage and the union of husband and wife', expected: ['Genesis 2', 'Ephesians 5', 'Matthew 19'], source: 'WSC Q71' },
  { id: 'f-tp-15', cat: 'topical', query: 'the last judgment before God', expected: ['Revelation 20', 'Matthew 25', '2 Corinthians 5'], source: 'HC LD 19' },
  { id: 'f-tp-16', cat: 'topical', query: 'the hope of eternal life', expected: ['John 17', '1 John 5', 'Titus 1'], source: 'HC LD 22' },
  { id: 'f-tp-17', cat: 'topical', query: 'angels and their ministry to the saints', expected: ['Hebrews 1', 'Psalm 91', 'Luke 1'] },
  { id: 'f-tp-18', cat: 'topical', query: 'creation declaring the glory of God', expected: ['Psalm 104', 'Romans 1', 'Acts 14'] },
  { id: 'f-tp-19', cat: 'topical', query: 'suffering and the patience of Job', expected: ['Job 1', 'Job 2', 'Romans 8'] },
  { id: 'f-tp-20', cat: 'topical', query: 'worship in spirit and in truth', expected: ['John 4', 'Psalm 95', 'Romans 12'] },
