...
import { createNeonStore } from '../retrieval/store.js';
...
//   DEEPINFRA_API_KEY=... pnpm ingest:embeddings jhn
...
async function main(): Promise<void> {
  ...
  if (!db) throw new Error('DATABASE_URL is required (env or web/.env.local)');
